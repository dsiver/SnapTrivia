...
ActiveRecord::Schema.define(version: 20150527205850) do
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.string   "payload"
    t.integer  "recipient_read", default: 0
    t.integer  "sender_read",    default: 0
  end
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.integer  "user_id"
    t.integer  "easy_ratings",   default: 0
    t.integer  "medium_ratings", default: 0
    t.integer  "hard_ratings",   default: 0
  end
