  ...
  def question_results
    ...
    if result == 'CORRECT'
      ...
      if subject == "Art"
        ...
        @game_id = game_id
        give_trophy(@current_game, "Art", @user)
      end
      if subject == "Entertainment"
        ...
        @game_id = game_id
        give_trophy(@current_game, "Entertainment", @user)
      end
      if subject == "History"
        correct = @user.correct_questions + 1
        ...
        @game_id = game_id
        give_trophy(@current_game, "History", @user)
      end
      if subject == "Geography"
        ...
        @game_id = game_id
        give_trophy(@current_game, "Geography", @user)
      end
      if subject == "Science"
        correct = @user.correct_questions + 1
        ...
        @game_id = game_id
        give_trophy(@current_game, "Science", @user)
      end
      if subject == "Sports"
        correct = @user.correct_questions + 1
        ...
        @game_id = game_id
        give_trophy(@current_game, "Sports", @user)
      end
      sleep(2)
      @user.save!
